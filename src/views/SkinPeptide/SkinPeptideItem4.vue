            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">PEPTIDE EYE BLESSING NIGHTLY CAPSULES</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/PEPTIDE EYE BLESSING SERIES/PEPTIDE EYE BLESSING NIGHTLY CAPSULES_30000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱30,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This perfectly dosed, capsuled night eye serum is designed to keep all the ingredients fresh until they are activated by contact with the skin and make it pleasantly soft and hydrated.</p>
