            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">FTV PEPTIDE EYE BLESSING MIRACLE PUFFINESS ELIMINATING CREAM</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/PEPTIDE EYE BLESSING SERIES/FTV PEPTIDE EYE BLESSING MIRACLE PUFFINESS ELIMINATING CREAM_23000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱23,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This miracle combination of key ingredients allows an immediate skin transformation, erasing the visible signs of fatigue, age and uneven texture under the eyes.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Prior to application, thoroughly cleanse your skin, making sure there are no traces of moisturizer, makeup or any other oily residues. Gently tap the product with your ring finger. Application should be performed directly to the under-eye area where puffiness and eye bags are located. Avoid any contact with the eyes. Do not rub and do not massage the cream. Allow the active ingredients to work for 5-8 minutes, during the wait keep your face expressionless. Do not rinse off. Avoid the use of any liquid skin care or makeup products, use only powder-based products.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
