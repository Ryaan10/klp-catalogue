            ...
            <ion-grid>
                <ion-row>
                    <ion-col style="text-align: center;">
                        <ion-img :src="'/assets/SKIN CARE CATEGORY/PEPTIDE EYE BLESSING SERIES/FTV PEPTIDE EYE BLESSING MIRACLE PUFFINESS ELIMINATING CREAM_23000.jpg'" @click="() => router.push('/skincheckmateItem1')"/>
                    ...
                    <ion-col style="text-align: center;">
                        <ion-img :src="'/assets/SKIN CARE CATEGORY/PEPTIDE EYE BLESSING SERIES/PEPTIDE EYE BLESSING FIRMARVEL CREAM_15000.jpg'" @click="() => router.push('/skincheckmateItem2')"/>
                ...
                <ion-row>
                    <ion-col style="text-align: center;">
                        <ion-img :src="'/assets/SKIN CARE CATEGORY/PEPTIDE EYE BLESSING SERIES/PEPTIDE EYE BLESSING INTENSIVE SERUM_15000.jpg'" @click="() => router.push('/skincheckmateItem3')"/>
                    ...
                    <ion-col style="text-align: center;">
                        <ion-img :src="'/assets/SKIN CARE CATEGORY/PEPTIDE EYE BLESSING SERIES/PEPTIDE EYE BLESSING NIGHTLY CAPSULES_30000.jpg'" @click="() => router.push('/skincheckmateItem4')"/>
