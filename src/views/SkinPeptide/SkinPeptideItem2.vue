            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">PEPTIDE EYE BLESSING FIRMARVEL CREAM</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/PEPTIDE EYE BLESSING SERIES/PEPTIDE EYE BLESSING FIRMARVEL CREAM_15000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱15,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This marvelous daily eye cream works to reduce the appearance of puffiness and dark circles around the eyes for a visibly brighter, fresher and younger look.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Using your ring finger, apply sparingly around the entire eye area using a gentle patting motion. Carefully avoid any contact with the eyes. Use daily in the morning. For best results use it after washing your face and after applying the Peptide Eye Blessing Intensive Serum. You can use the Freshwater Pearls facial cleansing soap which is our everyday basic facial cleaning series for all ages and skin types, or the Luxuriant Crystals Facial Soap designed specifically for dry skin type.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
