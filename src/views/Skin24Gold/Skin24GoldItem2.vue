      ...
      <ion-header collapse="condense">
       ...
       <div>
        ...
        <ion-list-header id="font">
            ...
            <ion-icon name="chevron-forward" style="color: white; margin-left: 3px; font-size: 13px"></ion-icon>
            <a style="color: white; margin-left: 3px; font-size: 13px; font-family: MontserratR; letter-spacing: 1px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 35%" @click="backToList()">24 KARAT GOLDEN HERO SERIES</a> 
            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">24 KARAT GOLDEN HERO FACIAL SERUM</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/24 KARAT GOLDEN HERO SERIES/24 KARAT GOLDEN HERO FACIAL SERUM_160000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱160,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This golden Facial Serum is designed to nourish, smooth, promote a uniform texture and improve the plumpness of the facial skin.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Apply evenly into a dry and clean face and neck. Massage in until fully absorbed. Use daily. For best results, follow by using 24 KARAT GOLDEN HERO Eye Cream and 24 KARAT GOLDEN HERO Hydration Cream.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
