    ...
    <ion-page>
        ...
        <div>
            ...
            <ion-list-header id="font">
                ...
                <a style="color: white; margin-left: 3px; font-size: 13px; font-family: MontserratR; letter-spacing: 1px">HAIR CARE</a>
            ...
            <ion-img :src="'/assets/homepage/4.jpg'"/>
            <p id="category">HAIR CARE<ion-img :src="'/assets/homepage/diamond.jpg'" style=" display: block; margin-left: auto; margin-right: auto; width: 30px; margin-top: 10px"/></p>
            <p style="margin: 10px; font-size: 14px; font-family: MontserratR; color: white; text-align: center;">Bring back your hair glam with the FTV Haircare line. Enriched with keratin, magical oils, and fabulous ingredients, each products will give that care solution that your hair needs - restoring that thicker, stronger, and healthier hair.</p>
            <ion-grid>
                <ion-row>
