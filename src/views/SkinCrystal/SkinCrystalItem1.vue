      ...
      <ion-header collapse="condense">
       ...
       <div>
        ...
        <ion-list-header id="font">
            ...
            <ion-icon name="chevron-forward" style="color: white; margin-left: 3px; font-size: 13px"></ion-icon>
            <a style="color: white; margin-left: 3px; font-size: 13px; font-family: MontserratR; letter-spacing: 1px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 37%" @click="backToList()">CRYSTAL - FUSION DECOLLIFTE SERIES</a> 
            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">CRYSTAL - FUSION DECOLLIFTE CREAM</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/CRYSTAL - FUSION DECOLLIFTE SERIES/CRYSTAL - FUSION DECOLLIFTE CREAM_15000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱15,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This rich nourishing Cream softens, firms, hydrates and protects the neck and décolleté area from environmental damages all day long and smooths fine lines and wrinkle appearance.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Apply the cream to dry and clean the neck and décolleté area. Use daily. For best results cleanse your neck and décolleté area using one of the other series Cleansers. You can use the Freshwater Pearls facial cleansing soap which is our everyday basic facial cleaning series for all ages and skin types, or the Luxuriant Crystals Facial Soap designed specifically for dry skin type.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
...
export default defineComponent({
    ...
    methods:{
        backToList() {
            this.$router.push({name: "skincrystal"})
        },
    }
