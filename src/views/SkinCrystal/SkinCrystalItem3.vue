            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">CRYSTAL - FUSION DECOLLIFTE MASK</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/CRYSTAL - FUSION DECOLLIFTE SERIES/CRYSTAL - FUSION DECOLLIFTE MASK_40000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱40,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This rejuvenating Mask, reveals a younger-looking, more even complexion of the neck and décolleté skin.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Apply an even layer onto dry and clean skin of neck and décolleté. Allow the ingredients to work for 10-15 minutes. Remove thoroughly with lukewarm water, then rinse skin with cool water (helps to shrink the pores) and pat dry. Use twice a week. For best results, follow by using CRYSTAL-FUSION DECOLLIFTE Lipid Capsules.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
