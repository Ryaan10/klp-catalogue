    ...
    <ion-page>
        ...
        <div>
            ...
            <ion-list-header id="font">
                ...
                <ion-icon name="chevron-forward" style="color: white; margin-left: 3px; font-size: 13px"></ion-icon>
                <a style="color: white; margin-left: 3px; font-size: 13px; font-family: MontserratR; letter-spacing: 1px">CRYSTAL - FUSION DECOLLIFTE SERIES</a>
            ...
            <ion-grid>
                <ion-row>
                    <ion-col style="text-align: center;">
                        <ion-img :src="'/assets/SKIN CARE CATEGORY/CRYSTAL - FUSION DECOLLIFTE SERIES/CRYSTAL - FUSION DECOLLIFTE CREAM_15000.jpg'" @click="() => router.push('/skincheckmateItem1')"/>
                    ...
                    <ion-col style="text-align: center;">
                        <ion-img :src="'/assets/SKIN CARE CATEGORY/CRYSTAL - FUSION DECOLLIFTE SERIES/CRYSTAL - FUSION DECOLLIFTE LIPID CAPSULES_30000.jpg'" @click="() => router.push('/skincheckmateItem2')"/>
                ...
                <ion-row>
                    <ion-col style="text-align: center;">
                        <ion-img :src="'/assets/SKIN CARE CATEGORY/CRYSTAL - FUSION DECOLLIFTE SERIES/CRYSTAL - FUSION DECOLLIFTE MASK_40000.jpg'" @click="() => router.push('/skincheckmateItem3')"/>
