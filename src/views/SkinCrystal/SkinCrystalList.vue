    ...
    <ion-page>
        ...
        <div>
            ...
            <ion-list-header id="font">
                ...
                <ion-icon name="chevron-forward" style="color: white; margin-left: 3px; font-size: 13px"></ion-icon>
                <a style="color: white; margin-left: 3px; font-size: 13px; font-family: MontserratR; letter-spacing: 1px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 37%">CRYSTAL - FUSION DECOLLIFTE SERIES</a>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        methods:{
            goToPage(id: number) {
                this.$router.push({name: "skincrystal", params: {id: id}})
            }
        }
