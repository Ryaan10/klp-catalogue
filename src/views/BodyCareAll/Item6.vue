                ...
                <ion-col>
                    ...
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        ...
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/BODY CARE CATEGORY/All Products/SUPER MODEL RED CARPET SHEA BODY LOTION_6900.png'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
