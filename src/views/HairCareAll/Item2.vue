            ...
            <ion-row style="color: white">
                <ion-col>
                    ...
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">CELEB STYLE NOURISHING CONDITIONER</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/HAIR CARE CATEGORY/All Products/NOURISHING CONDITIONER_49.976.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱4,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This conditioner is designed to nourish, strengthen and soften your hair, leaving it smooth, manageable and shiny.</p>

                         <p style="font-size: 15px; font-family: MontserratR;">HOW TO USE</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Apply to wet hair following FTV CELEB STYLE Nourishing Shampoo. Pump as much as needed into the palm of your hand and run through the ends of your hair and up, try to reach every strand. Leave on for 2-3 minutes and rinse thoroughly.</p><!-- <iframe style="margin-top: 50px" width="400" height="400" src="https://www.youtube.com/embed/dPCUT80VFm4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
