            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">FLASH WHITE PEARLS FACIAL SERUM</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/FLASH WHITE PEARL SERIES/FLASH WHITE PEARLS FACIAL SERUM_20000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱20,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This Facial Serum nourishes the skin and refines its tone and texture for a smoother and brighter appearance and sensation.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Gently massage the serum on a clean and dry face and neck until fully absorbed. Use daily. For best results, first clean your face with Freshwater Pearls Facial Cleaning Soap and after the serum follow by using FLASH WHITE PEARLS Hydra Cream.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
