      ...
      <ion-header collapse="condense">
       ...
       <div>
        ...
        <ion-list-header id="font">
            ...
            <ion-icon name="chevron-forward" style="color: white; margin-left: 3px; font-size: 13px"></ion-icon>
            <a style="color: white; margin-left: 3px; font-size: 13px; font-family: MontserratR; letter-spacing: 1px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 37%" @click="backToList()">FLASH WHITE PEARL SERIES</a> 
            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">FLASH WHITE PEARLS FACIAL MASK</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/FLASH WHITE PEARL SERIES/FLASH WHITE PEARLS FACIAL MASK_30000.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱30,000</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This brightening, skin tone unifying Facial Mask, visibly corrects uneven complexion’s appearance, softens and smoothes the skin.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Apply an even layer onto dry and clean skin, carefully avoiding the eye area. Allow the purifying ingredients to work for 8-10 minutes. Remove thoroughly with lukewarm water, then rinse skin with cool water and pat dry. Use twice a week. For best results, follow by using FLASH WHITE PEARLS Facial Serum.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
...
export default defineComponent({
    ...
    methods:{
        backToList() {
            this.$router.push({name: "skinflashwhite"})
        },
    }
