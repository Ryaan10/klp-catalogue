            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">FRESHWATER PEARLS FACIAL CLARIFYING MILK</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/FRESHWATER PEARLS SERIES/FRESHWATER PEARLS FACIAL CLARIFYING MILK_6900.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱6,900</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This skin-softening clarifying milk is designed to efficiently get rid of any remaining residue of dirt or facial makeup that might be left after the facial soap, while also nourishing and hydrating the skin.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Pour the facial milk on a clean cotton pad and apply on your face and neck with gentle circular motion. Remove with a clean cotton pad. Use daily in the morning and the evening. For best results, follow by using FRESHWATER PEARLS Facial Toner.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
