      ...
      <ion-header collapse="condense">
       ...
       <div>
        ...
        <ion-list-header id="font">
            ...
            <ion-icon name="chevron-forward" style="color: white; margin-left: 3px; font-size: 13px"></ion-icon>
            <a style="color: white; margin-left: 3px; font-size: 13px; font-family: MontserratR; letter-spacing: 1px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; width: 37%" @click="backToList()">FRESHWATER PEARLS SERIES</a> 
            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">FRESHWATER PEARLS EYE MAKEUP REMOVER</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/FRESHWATER PEARLS SERIES/FRESHWATER PEARLS EYE MAKEUP REMOVER_6900.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱6,900</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This gentle Eye Makeup Remover removes makeup while providing your eye area with a wonderful spa sensation.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Saturate cotton pad with the eye makeup remover. Apply to the eye area and hold for several seconds, then wipe to the side. Repeat using fresh cotton pad if necessary. Use a new cotton pad for each eye. Designed for daily use. For best results follow by using the PEPTIDE EYE BLESSING Intensive Serum (morning), Firmarvel Eye Cream (morning) and Nightly Capsules (as your nightly serum).</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
...
export default defineComponent({
    ...
    methods:{
        backToList() {
            this.$router.push({name: "skinfreshwater"})
        },
    }
