            ...
            <ion-row style="color: white">
                <ion-col>
                    <div style="text-align: center; margin-top: 10px; color: white; z-index: -1">
                        <p style="font-family: MontserratR;">FRESHWATER PEARLS FACIAL TONER</p>
                        <ion-slides pager="false" :options="slideOpts" ref="mySlides">
                            <ion-slide>
                                <div>
                                    <ion-img :src="'/assets/SKIN CARE CATEGORY/FRESHWATER PEARLS SERIES/FRESHWATER PEARLS FACIAL TONER_6900.jpg'" id="product" style="margin-top: 15px; margin-bottom: 15px; height: 300px;"/>
                                </div>
                            </ion-slide>
                        </ion-slides>  
                        <p style="font-family: BodoniR;">₱6,900</p>
                        <p style="font-size: 15px; font-family: MontserratR;">DETAILS</p>
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">This skin-awakening formula gently refreshes and tones your complexion, helps to clear makeup residues, reduces oily shine, remove excess oil and dead skin cells and refine pore appearance.</p>
                        ...
                        <p style="padding-left: 10px; padding-right: 10px; font-size: 15px; font-family: MontserratR;">Dampen a cotton pad with the toner, lightly massage over the entire dry face for 10 to 20 seconds, carefully avoiding the eye area. Repeat using a fresh cotton ball if necessary. Use daily.</p>
                    </div>
                </ion-col>
            </ion-row>
        </ion-grid>
